...
class DetailsActivityEspressoTest {
    ...
    fun activityTextView_NotNull() {
        scenario.onActivity {
            val totalCountTextView = it.findViewById<TextView>(R.id.totalCountTextView_details)
    ...
    fun activityTextView_HasText() {
        ...
        onView(withId(R.id.totalCountTextView_details)).check(assertion)
    }

    @Test
    fun activityTextView_IsDisplayed() {
        onView(withId(R.id.totalCountTextView_details)).check(matches(isDisplayed()))
    }

    @Test
    fun activityTextView_IsCompletelyDisplayed() {
        onView(withId(R.id.totalCountTextView_details)).check(matches(isCompletelyDisplayed()))
    }
    ...
    fun activityButtonIncrement_IsWorking() {
        ...
        onView(withId(R.id.totalCountTextView_details)).check(matches(withText("Number of results: 1")))
    }
